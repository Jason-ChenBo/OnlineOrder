...
public class ApplicationConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://laiproject-database.cwswdfvpyjpy.us-east-2.rds.amazonaws.com:3306/onlineOrder?createDatabaseIfNotExist=true&serverTimezone=UTC");
